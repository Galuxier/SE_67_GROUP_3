      ...
      <div className="bg-white shadow-lg rounded-2xl p-8 w-full max-w-6xl flex flex-col md:flex-row gap-8">
        ...
        <div className="w-full md:w-1/3 md:border-l md:pl-8 mt-8 md:mt-0">
          ...
          <div className="bg-gray-50 p-4 rounded-lg mb-4">
            <h3 className="font-medium text-lg mb-1">{course.course_name || "ZONE A"}</h3>
            <div className="flex justify-between items-center">
              <p className="text-gray-600">{course.gym || "Standard"}</p>
          ...
          <div className="flex justify-between items-center pt-4 border-t border-gray-200">
            ...
            <p className="text-red-500 text-xl font-bold">
              {typeof course.price === 'number' ? (course.price * quantity).toLocaleString() : "2,400"} บาท
            </p>
          </div>
        </div> 
      </div> 
